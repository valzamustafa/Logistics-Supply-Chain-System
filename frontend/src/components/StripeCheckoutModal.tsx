    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 px-4 py-8">
      <div className="w-full max-w-xl rounded-3xl border border-slate-200 bg-slate-50 p-6 shadow-2xl overflow-y-auto max-h-[90vh]">
        ...
        <div className="space-y-4">
          <div>
            <label className="block text-sm text-slate-500 mb-2">Cardholder Name</label>
            <input
              type="text"
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4">
            <label className="block text-sm text-slate-500 mb-2">Card details</label>
            <div className="rounded-xl border border-slate-600 bg-slate-50 p-3">
              <CardElement options={{
                style: {
                  base: {
                    color: '#e2e8f0',
