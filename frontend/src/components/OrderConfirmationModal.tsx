    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-lg p-6 max-w-md w-full max-h-[90vh] overflow-y-auto border border-slate-200">
        ...
        <div className="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
          ...
          <p className="text-slate-500"><strong className="text-slate-900">Status:</strong> {order.status}</p>
        </div>
        ...
        <div className="mb-6 p-4 bg-slate-50 rounded-lg border border-slate-200">
          ...
          <div className="bg-white p-3 rounded border border-slate-600">
            <p className="text-slate-500"><strong className="text-slate-900">Beneficiary:</strong> Logjistika SH.P.K.</p>
            <p className="text-slate-500"><strong className="text-slate-900">Bank:</strong> Banka Ekonomike</p>
            <p className="text-slate-500"><strong className="text-slate-900">IBAN:</strong> XK05 1234 5678 9012 3456</p>
            <p className="text-slate-500"><strong className="text-slate-900">SWIFT:</strong> BAKXKS10</p>
            <p className="text-slate-500"><strong className="text-slate-900">Reference:</strong> Order #{order.orderNumber}</p>
          </div>
        </div>
