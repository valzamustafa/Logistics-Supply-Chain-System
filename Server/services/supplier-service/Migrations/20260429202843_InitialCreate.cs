    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmergencyPurchases", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierInvitations_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "SupplierWarehouseAssignments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SupplierWarehouseAssignments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SupplierWarehouseAssignments_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierInvitations_SupplierId",
                table: "SupplierInvitations",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_SupplierInvitations_Token",
                table: "SupplierInvitations",
                column: "Token",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierWarehouseAssignments_SupplierId",
                table: "SupplierWarehouseAssignments",
                column: "SupplierId");
        }
