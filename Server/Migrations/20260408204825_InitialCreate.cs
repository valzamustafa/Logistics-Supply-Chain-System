        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeadTimeDays = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: false),
                    UpdatedBy = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseZone", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WarehouseZone_Warehouses_WarehouseId",
                        column: x => x.WarehouseId,
                        principalTable: "Warehouses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SupplierOrderItem_SupplierOrder_SupplierOrderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DriverAssignment_Shipments_ShipmentId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 4, 8, 20, 48, 24, 494, DateTimeKind.Utc).AddTicks(6323), 1, "Full system access", "Admin", new DateTime(2026, 4, 8, 20, 48, 24, 494, DateTimeKind.Utc).AddTicks(6600), 1 },
                    { 2, new DateTime(2026, 4, 8, 20, 48, 24, 494, DateTimeKind.Utc).AddTicks(6838), 1, "Manage operations", "Manager", new DateTime(2026, 4, 8, 20, 48, 24, 494, DateTimeKind.Utc).AddTicks(6838), 1 },
                    { 3, new DateTime(2026, 4, 8, 20, 48, 24, 494, DateTimeKind.Utc).AddTicks(6841), 1, "Regular user", "User", new DateTime(2026, 4, 8, 20, 48, 24, 494, DateTimeKind.Utc).AddTicks(6842), 1 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DriverAssignment_ShipmentId",
                table: "DriverAssignment",
                column: "ShipmentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseZone_WarehouseId",
                table: "WarehouseZone",
                column: "WarehouseId");
        }
